(function() {
  ...
  Model = (function(_super) {
    ...
    Model.prototype["delete"] = function() {
      if (this.id) delete this.constructor.records[this.id];
      return delete this.constructor.crecords[this.cid];
    };
